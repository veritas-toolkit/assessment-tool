...
public interface TemplateQuestionMapper extends QuestionValueMapper<TemplateQuestion> {
    ...
    default Class<TemplateQuestion> getEntityClass() {
        return TemplateQuestion.class;
    }

    @Override
    default Supplier<TemplateQuestion> questionSupplier() {
        return TemplateQuestion::new;
    }

    @Override
    default SFunction<TemplateQuestion, Integer> questionnaireIdFunction() {
        return TemplateQuestion::getTemplateId;
    }
