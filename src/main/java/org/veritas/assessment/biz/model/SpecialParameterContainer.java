...
@Getter
public class SpecialParameterContainer {
    private Map<String, Applicant> applicantMap = Collections.emptyMap();


    public SpecialParameterContainer(JsonModel jsonModel) {
        if (jsonModel == null) {
            return;
        }
