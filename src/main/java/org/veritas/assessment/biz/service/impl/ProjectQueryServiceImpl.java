...
public class ProjectQueryServiceImpl implements ProjectQueryService {
    ...
    @Override
    public Pageable<Project> findProjectPageable(String prefix, String keyword, int page, int pageSize) {
        return projectMapper.findProjectPageable(prefix, keyword, page, pageSize);
    }
}
