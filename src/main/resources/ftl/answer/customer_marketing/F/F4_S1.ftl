...
<li><b>TMeasurement bias</b> arises when there is systematic or non-random error in the collection of data, and can occur on input variables and target labels on which the AIDA system operates.</li>
<li><b>Pre-processing bias</b> arises during data pre-processing in model development, when an operation
(e.g., missing value treatment, data cleansing, outlier treatment, encoding, scaling or data transformations for unstructured data, etc.) causes or contributes to systematic disadvantage.</li>
</ul>
