...
<div>
    The extent to which such transparency is needed, and the audience for the same, will be determined by the materiality of the AIDA use case.
    Different audiences will require different levels of technical detail from the explanations.
...
<div class="table_box">
    <table border="1">
            ...
            <tr>
                ...
                <td>Fairness/explainability metrics/ transparency reports including various metrics for fairness/ explainability/ etc.</td>
            </tr>
            <tr>
